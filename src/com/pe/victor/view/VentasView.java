...
//        }
  ...
  // End of variables declaration//GEN-END:variables
    ...
    private void cargaListas() throws Exception {
        // combo cliente
        ClienteService ocli = new ClienteServiceImpl();
        cbocliente.removeAllItems();
        for (Cliente c : ocli.listar()) {
            cbocliente.addItem(c);
        }
        //combo de empleado
        EmpleadoService oemp = new EmpleadoServiceImpl();
        cboEmpleado.removeAllItems();
        for (Empleado e : oemp.listar()) {
            cboEmpleado.addItem(e);
        }
        //combo de producto
        ProductoService opro = new ProductoServiceImpl();
        cboproducto.removeAllItems();
        for (Producto p : opro.listar()) {
    ...
    private void mostrarDatos() throws Exception {
        ...
        ProductoService pro = new ProductoServiceImpl();
        p = pro.buscar(cod);
        stk = p.getStock();
    ...
    private void grabarVenta() {
        try {
            ...
            VentaService oVenta = new VentaService();
            Venta ve = new Venta();
